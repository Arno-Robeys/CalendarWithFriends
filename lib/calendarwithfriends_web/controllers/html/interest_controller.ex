defmodule CalendarwithfriendsWeb.Html.InterestController do
  ...
  def create(conn, %{"interest" => interest_params}) do
    case Interests.create_interest(interest_params) do
      {:ok, interest} ->
        ...
        |> redirect(to: Routes.html_interest_path(conn, :show, interest))
  ...
  def delete(conn, %{"id" => id}) do
    ...
    |> redirect(to: Routes.html_interest_path(conn, :index))
  end
end
