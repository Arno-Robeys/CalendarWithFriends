defmodule Calendarwithfriends.Accounts do
  @moduledoc """
  ...
  alias Calendarwithfriends.Accounts.{User, UserToken, UserNotifier}
  ...
  def get_user_by_full_name(full_name) when is_binary(full_name) do
    Repo.get_by(User, full_name: full_name)
  end
