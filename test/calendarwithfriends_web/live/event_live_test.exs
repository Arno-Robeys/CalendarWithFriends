defmodule CalendarwithfriendsWeb.EventLiveTest do
  ...
  @create_attrs %{
    ...
    end_time: %{day: 25, hour: 18, minute: 13, month: 4, year: 2023},
    is_private: true,
    start_time: %{day: 25, hour: 18, minute: 13, month: 4, year: 2023},
    title: "some title"
  }
  @update_attrs %{
    description: "some updated description",
    end_time: %{day: 26, hour: 18, minute: 13, month: 4, year: 2023},
    is_private: false,
    start_time: %{day: 26, hour: 18, minute: 13, month: 4, year: 2023},
    title: "some updated title"
  }
  @invalid_attrs %{
    description: nil,
    end_time: %{day: 30, hour: 18, minute: 13, month: 2, year: 2023},
    is_private: false,
    start_time: %{day: 30, hour: 18, minute: 13, month: 2, year: 2023},
    title: nil
  }
